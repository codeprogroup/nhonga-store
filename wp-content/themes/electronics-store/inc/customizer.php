...
function electronics_store_customize_register( $wp_customize ) {
    ...
    // text trasform
	$wp_customize->add_setting('electronics_store_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'electronics_store_sanitize_choices'
	));
	$wp_customize->add_control('electronics_store_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','electronics-store'),
		'section'=> 'electronics_store_footer_section',
		'choices' => array(
	      'Uppercase' => __('Uppercase','electronics-store'),
	      'Capitalize' => __('Capitalize','electronics-store'),
